# orq-poc-typescript-multi-env-version

Developer-friendly & type-safe Typescript SDK specifically catered to leverage *orq-poc-typescript-multi-env-version* API.

<div align="left">
    <a href="https://www.speakeasy.com/?utm_source=orq-poc-typescript-multi-env-version&utm_campaign=typescript"><img src="https://custom-icon-badges.demolab.com/badge/-Built%20By%20Speakeasy-212015?style=for-the-badge&logoColor=FBE331&logo=speakeasy&labelColor=545454" /></a>
...
```bash
npm add orq-poc-typescript-multi-env-version
```

### PNPM

```bash
pnpm add orq-poc-typescript-multi-env-version
```

### Bun

```bash
bun add orq-poc-typescript-multi-env-version
```

### Yarn

```bash
yarn add orq-poc-typescript-multi-env-version zod
...
### SDK Created by [Speakeasy](https://www.speakeasy.com/?utm_source=orq-poc-typescript-multi-env-version&utm_campaign=typescript)
