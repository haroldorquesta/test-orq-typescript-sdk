...
```typescript
import { PostV2LogsQueryItemsRequestProperties } from "orq-poc-typescript-multi-env-version/models/operations";

let value: PostV2LogsQueryItemsRequestProperties = {};
```
