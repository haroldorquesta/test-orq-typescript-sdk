...
```typescript
import { GetV2LogsIdEvalsResponseRequestProperties } from "orq-poc-typescript-multi-env-version/models/operations";

let value: GetV2LogsIdEvalsResponseRequestProperties = {};
```
