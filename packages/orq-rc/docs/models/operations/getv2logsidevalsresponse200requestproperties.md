...
```typescript
import { GetV2LogsIdEvalsResponse200RequestProperties } from "orq-poc-typescript-multi-env-version/models/operations";

let value: GetV2LogsIdEvalsResponse200RequestProperties = {};
```
