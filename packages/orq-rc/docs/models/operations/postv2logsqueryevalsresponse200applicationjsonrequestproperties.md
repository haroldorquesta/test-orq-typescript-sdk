...
```typescript
import { PostV2LogsQueryEvalsResponse200ApplicationJSONRequestProperties } from "orq-poc-typescript-multi-env-version/models/operations";

let value: PostV2LogsQueryEvalsResponse200ApplicationJSONRequestProperties = {};
```
