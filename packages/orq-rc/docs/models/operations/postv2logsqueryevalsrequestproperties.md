...
```typescript
import { PostV2LogsQueryEvalsRequestProperties } from "orq-poc-typescript-multi-env-version/models/operations";

let value: PostV2LogsQueryEvalsRequestProperties = {};
```
