...
```typescript
import { PostV2LogsQueryItemsResponseRequestProperties } from "orq-poc-typescript-multi-env-version/models/operations";

let value: PostV2LogsQueryItemsResponseRequestProperties = {};
```
